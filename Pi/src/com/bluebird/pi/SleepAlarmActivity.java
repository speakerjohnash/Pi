...
public class SleepAlarmActivity extends CustomMethods {
	...
	// Set Off Repeating Vibration
			final Vibrator vibrator = (Vibrator) SleepAlarmActivity.this.getSystemService(Context.VIBRATOR_SERVICE);
    ...
    alertbox.setMessage("Go to Sleep Bitch");
